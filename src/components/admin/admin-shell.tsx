...
import { Activity, BarChart3, CreditCard, HeartPulse, LayoutDashboard, LogOut, Megaphone, Menu, ShieldCheck, Users, X } from "lucide-react"
...
const navigation = [
  ...
  { href: "/admin/operations", label: "Operations", icon: HeartPulse },
